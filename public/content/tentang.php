...
.biodata {
  ...
  <body>
        <h1 class="text-center text-success mt-3">Biodata diri</h1>
<div class="container">
  <div class="card kartu">
    <div class="row">
      <div class="col-md-4">
      <div class="foto">
        <img src="foto/b.jpg" class="img-thumbnail" alt="" width="150" height="auto">
      </div>
      </div>
          ...
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: #e9a7f9; font-weight:bold"> Cintani Barmula</td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <tr>
              <td valign="top" class="textt">SOSMED</td>
                <td valign="top">:</td>
                <td>Instagram @cintani_barmula</td>
            </tr>
            <tr>
